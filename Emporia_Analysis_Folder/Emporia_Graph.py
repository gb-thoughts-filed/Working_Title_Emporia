...
time_single_loop_0314_8cores, energy_one_solve_0314_8cores, _, _, _, _, _, _, _ = \
    np.loadtxt("tolerance_testing_20240314/Emporia_Results_Extended_20240311104009.csv", skiprows=1, delimiter=",", dtype=str,
               unpack=True)
...
time_single_loop_0510_1core, energy_one_solve_0510_1core, _, _, _, _ = \
    np.loadtxt("tolerance_testing_20240510/Emporia_Results_Extended_20240506100247.csv", skiprows=1, delimiter=",", dtype=str,
               unpack=True)
#########################################
...
plt.scatter(time_single_loop_0314_8cores, energy_one_solve_0314_8cores, label="8 cores")
plt.scatter(time_single_loop_0510_1core, energy_one_solve_0510_1core, label="1 core")
...
plt.title("Time v.s. Energy Plot - Tolerance Set To 10^-6 - Zoom 2")
plt.xlabel("Time Per Solve")
plt.ylabel("Energy Per Solve")
plt.legend()
